...
| HOME-01 | Powitanie i passa tygodniowa na Home | Wchodząc do aplikacji widzę powitanie po imieniu i w którym tygodniu passy jestem; karta startu zostaje pierwsza | gotowe do podjęcia · `spec-home-i-nawigacja.md` |
| HOME-02 | Podsumowanie okresu i kafle na Home | Trzy liczby na wejściu mówią, czy idzie do przodu; pełna analiza zostaje w Treningu | po HOME-01; wymaga pomiaru budżetu gorącej trasy |
