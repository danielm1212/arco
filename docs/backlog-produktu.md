...
| PLAN-05B | Komponent `ProgramCover` (zdjęcie / fallback) | Karta ma kotwicę wizualną nawet bez zdjęcia — gradient wg `focus_key` + istniejąca ikona 3D `plan`, zero nowych assetów | gotowe do podjęcia po wdrożeniu PLAN-05A |
