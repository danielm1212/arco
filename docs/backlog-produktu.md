...
| PLAN-05D | Przebudowa szczegółu planu (`/programs/[id]`) | Zdjęcie/fallback, jeden wiersz faktów, CTA nad zgięciem, opis w akordeonie, „Jak robić postęp” usunięte (identyczne na 15 planach) | gotowe technicznie 2026-07-30 na `agent/plan-05d-program-detail`; czeka na review/merge i checkpoint [Ty] |
