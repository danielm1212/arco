...
| Treści Hip Thrust, Chin-Up i opisy ćwiczeń | CONTENT-01–CONTENT-03 | Q1 |
...
| TRAIN-01 | Pilny patch P11/P12/P14 | Ruchy techniczne i mocy są przed zmęczeniem, a plan FBW ma hinge; wersja treści i zatwierdzenie Codex są jawne | wdrożone lokalnie na `agent/q1-train-01`; oczekuje PR i migracji | Q1 |
