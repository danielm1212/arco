...
| NAV-01 | Trzy taby i zakładki Treningu | Nawigacja ma trzy jasne miejsca; Plany, Postępy, Ciało i Historia są w jednym pasku (D-38) | gotowe technicznie 2026-07-30 na `agent/nav-01-primary-navigation`; musi zostać scalone **przed PLAN-05D i R2.2** |
