...
> **Data:** 2026-07-08 · **Podstawa:** `usability-audit.md` §C (zadania) + `wizja-i-plan-produktu-v2.md` Krok 1 (moduły WTP i pody, +25 min) + `feedback-uzytkownikow.md` #1 (first-click test) + bramka **B1** (wizja §7).
...
Testujemy trzy rzeczy naraz: **(a) usability rdzenia** (zadania §3), **(b) willingness-to-pay** (moduł §4), **(c) tezę podową** (moduł §5).
...
- **Czas (70 min):** 5' intro · 5' first-click · 25' zadania · 15' WTP · 10' pody · 5' zamknięcie · 5' bufor.
...
**B4 · Test kotwicy:** „Arco Coach kosztuje **14,99 zł/mies. albo 99 zł/rok** — pełne prowadzenie i głęboka analityka; logowanie i pody zawsze darmowe. Pierwsza reakcja?" *(obserwuj twarz zanim odpowie)*. Follow-up jeśli zna Hevy: „Hevy Pro to ~13 zł/mies. — zmienia coś?"
...
3. „Mogę się odezwać przy testach podów?" *(seed listy oczekujących!)*
...
| C1 ma Radka? kto? | |
| C2 reakcja na pod / nudge: | |
| Cytat sesji (jeden, najmocniejszy): | |

## 8. Po sesjach — rozstrzygnięcie B1

Zbierz arkusze → policz: bloki w zadaniach (0 wymagane) · ile osób w B2 wybrało guidance/analitykę (próg ≥3/5) · ile ma Radka (≥3/5) · mediany Van Westendorpa vs 14,99 · **ile osób zgodziło się na kontakt przy testach podów (pytanie 3 zamknięcia) — to behawioralny sygnał zainteresowania podami, mocniejszy niż deklaracje z C2; licz go obok progu Radka**.
