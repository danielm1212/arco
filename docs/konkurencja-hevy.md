...
| Prywatne pody (1–3) | 🟢 **rdzeń strategii wzrostu** (awans z 🟢-przyszłość — fast-follow po launchu) | Nie chcą | **Nie** |
...
- **Pody (1–3 + reakcje + nudge)** — 🔄 awans (2026-07-08): **fast-follow 4–8 tyg. po launchu** jako silnik wzrostu (wizja v2 §4/§6), nie Horyzont 5. Nudge bez natywu: push PWA → skrzynka w apce → e-mail (fallback chain, wizja v2 §4). Reszta socialu (stories, UGC, tablica) zostaje w H5.
