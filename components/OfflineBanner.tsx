...
export function OfflineBanner() {
  ...
  return (
    ...
    <div className="fixed inset-x-0 top-0 z-50 bg-warning/95 px-md pb-1.5 pt-[calc(0.375rem+env(safe-area-inset-top))] text-center text-xs font-medium text-warning-foreground">
