...
export const TRAINING_PRIORITIES = [
  ...
  { id: "fat_loss", label: "Redukcja / utrzymanie", hint: "Chcę utrzymać siłę i mięśnie, gdy schudnę albo trzymam wagę.", loggerHint: "Utrzymuj jakość i ciężar. Przy wyraźnie słabszej regeneracji odejmij serię dodatkową, nie obciążenie od razu." },
] as const;
