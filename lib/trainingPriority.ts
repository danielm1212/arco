...
export const TRAINING_PRIORITIES = [
  ...
  { id: "fat_loss", label: "Redukcja / utrzymanie", hint: "Chcę utrzymać siłę i mięśnie, będąc na deficycie lub po nim.", loggerHint: "Utrzymuj jakość i ciężar. Przy wyraźnie słabszej regeneracji odejmij serię dodatkową, nie obciążenie od razu." },
] as const;
