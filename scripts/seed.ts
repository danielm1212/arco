    ...
    days: [
      {
        label: "FBW 2x · A",
        slots: [
          { exercise_id: "Barbell_Squat", sets: 3, repsMin: 8, repsMax: 10, rest: 150 },
          { exercise_id: "Barbell_Bench_Press_-_Medium_Grip", sets: 3, repsMin: 8, repsMax: 12, rest: 150 },
          { exercise_id: "One-Arm_Dumbbell_Row", sets: 3, repsMin: 10, repsMax: 12, rest: 120 },
          { exercise_id: "Dumbbell_Shoulder_Press", sets: 3, repsMin: 10, repsMax: 12, rest: 120 },
          { exercise_id: "Plank", sets: 3, repsMin: null, repsMax: null, rest: 60, notes: "30-45 s" },
        ],
      },
      {
        label: "FBW 2x · B",
        slots: [
          ...
          { exercise_id: "Bodyweight_Walking_Lunge", sets: 3, repsMin: 10, repsMax: 10, rest: 120, notes: "na nogę" },
          { exercise_id: "Hanging_Leg_Raise", sets: 3, repsMin: null, repsMax: null, rest: 90, notes: "AMRAP" },
        ],
      },
    ],
  },
    ...
    days: [
      {
        ...
        slots: [
          ...
          { exercise_id: "Barbell_Bench_Press_-_Medium_Grip", sets: 3, repsMin: 8, repsMax: 10, rest: 150 },
          { exercise_id: "One-Arm_Dumbbell_Row", sets: 3, repsMin: 10, repsMax: 12, rest: 120 },
          { exercise_id: "Dumbbell_Shoulder_Press", sets: 3, repsMin: 10, repsMax: 12, rest: 120 },
          { exercise_id: "Plank", sets: 3, repsMin: null, repsMax: null, rest: 60, notes: "40 s" },
        ],
      },
      {
        label: "FBW 3x · B",
        slots: [
          ...
          { exercise_id: "Pullups", sets: 3, repsMin: 6, repsMax: 10, rest: 150 },
          { exercise_id: "Incline_Dumbbell_Press", sets: 3, repsMin: 10, repsMax: 12, rest: 120 },
          { exercise_id: "Face_Pull", sets: 3, repsMin: 12, repsMax: 15, rest: 90 },
          { exercise_id: "Hanging_Leg_Raise", sets: 3, repsMin: null, repsMax: null, rest: 90, notes: "AMRAP" },
        ],
      },
      {
